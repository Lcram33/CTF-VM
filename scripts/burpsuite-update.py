#!/usr/bin/python3
#
# Downloads the latest burpsuite community jar file and saves it to /usr/share/burpsuite_community.jar (the default location at time of writing)
...
BURP_PATH = "/home/jack/BurpSuiteCommunity"
...
version_heading = content.find('head').find_next('title')
latest_version = version_heading.text[25:].split(' ')[0]
...
os.system("sudo rm burpsuite_community.jar.old 2>/dev/null")
os.system("sudo mv burpsuite_community.jar burpsuite_community.jar.old")
print(download_link)
os.system("sudo wget -O burpsuite_community.jar {}".format(download_link))
